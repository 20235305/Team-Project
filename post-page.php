...
<body>
    ...
    <div class="background-image">
            <div class="rectangle">
                ...
                <p class="feedText">Create a post</p>
    ...
    <div class="userPost-box">
        ...
        <img class="christinaPIC" src="images/blank-user-profile.png" alt="user icon"/>
        </button>
        <p class="jSmithText">Paddy O Toole</p>
        <br>
        <div class="buttonWrapper">
            <form method="post" enctype="multipart/form-data">
            <input name="post" type="text" id="description-box" placeholder="Add a description here...">
        </div>
        <br>
        ...
        <br>
        <!-- <button>
            <img class="lasagnaPic" src="images/no-image.jpg" alt="no image pic">
        </button> -->
